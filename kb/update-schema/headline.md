# Headline field (type: headline)

## Field summary

UI-only heading in the Panel; no content is stored.
...
- Confirm Panel options via `kirby://field/headline`.
...
- https://getkirby.com/docs/reference/panel/fields/headline
