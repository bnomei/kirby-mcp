...
We are creating a **new** set of knowledgebase documents as Markdown files under `/kb/glossary`.
...
- `kb/scenarios/` (task playbooks; out of scope here)
...
- One term per file: `kb/glossary/<slug>.md`
- Slug rules:
...
Optional (later): add `kb/glossary/INDEX.md` as an alphabetical list of entries.
...
- Plan: once the glossary is populated, extend/duplicate KB search to include `kb/glossary/`
