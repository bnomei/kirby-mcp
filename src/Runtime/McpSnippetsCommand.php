...
final class McpSnippetsCommand extends McpRuntimeCommand
{
    /**
     * @return array{
     *   description: string,
    ...
    public static function run(CLI $cli): void
    {
        ...
        try {
            ...
            $files = is_string($snippetsRoot) && $snippetsRoot !== '' && is_dir($snippetsRoot)
                ? McpExtensionRegistryIndexer::scanPhpFiles($snippetsRoot, static function (string $rootRelativePath): ?string {
