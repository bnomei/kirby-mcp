...
final class McpControllersCommand extends McpRuntimeCommand
{
    /**
     * @return array{
     *   description: string,
    ...
    public static function run(CLI $cli): void
    {
        ...
        try {
            ...
            $files = is_string($controllersRoot) && $controllersRoot !== '' && is_dir($controllersRoot)
                ? McpExtensionRegistryIndexer::scanPhpFiles($controllersRoot, static function (string $rootRelativePath): ?string {
            ...
            $merged = McpExtensionRegistryIndexer::merge($extensions, $files, static function (mixed $value): array {
                return [
