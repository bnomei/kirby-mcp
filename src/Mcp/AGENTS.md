...
- Shared-token HTTP auth is loopback/local-development only. Production or non-loopback HTTP exposure must use OAuth JWT validation with issuer, audience/resource, signature/JWKS, expiry, and scope checks.
